...
export default function RSVP() {
  ...
  const RSVP_DEADLINE = new Date("2026-08-20T00:00:00+02:00");
    ...
    <section id="rsvp" className={styles.section}>
      <div className={styles.container}>
        <div className={styles.chapterRow}>
          <span className={`label-caps reveal ${styles.chapter}`}>
            {t.rsvp.chapter}
          </span>
        ...
        <div className={styles.bento}>
          <div className={`${styles.photoSide} reveal-scale`}>
            ...
            <div className={styles.photoCaption}>
              ...
              <p className={`label-caps ${styles.captionDate}`}>
                {t.rsvp.captionDate}
              </p>
            </div>
          </div>
          ...
          <div className={`${styles.formPanel} reveal-right d1`}>
            <span className={`label-caps ${styles.formLabel}`}>
              {t.rsvp.label}
            </span>
            ...
            {sent ? (
              ...
              <div className={styles.closedBox}>
                ...
                <p className={styles.closedTitle}>{t.rsvp.closedTitle}</p>
                <p className={styles.closedText}>{t.rsvp.closedMessage}</p>
              </div>
            ) : (
              <form onSubmit={submit} className={styles.form}>
                <div className={styles.field}>
                  <label className={`label-caps ${styles.fieldLabel}`}>
                    {t.rsvp.nameLabel}
                  </label>
                  <input
                    type="text"
                ...
                <div className={styles.row}>
                  <div className={styles.field}>
                    ...
                    <select
                      name="attending"
                      value={form.attending || confirmVal}
                      onChange={change}
